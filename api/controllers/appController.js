...
exports.mo = (req, res) => {
    ...
    if (method == 'POST') {
        ...
        console.log('Its a POST requets!');
        log.info('Its a POST requets!');
        res.setHeader('Content-Type', 'application/json');
        res.end(JSON.stringify({data:'Ok POST'}, null, 3));
        ...
        console.log('Its a GET requets!');
        log.info('Its a GET requets!');
        res.setHeader('Content-Type', 'application/json');
        res.end(JSON.stringify({data:'Ok'}, null, 3));
        //res.send('OK');
    }
};